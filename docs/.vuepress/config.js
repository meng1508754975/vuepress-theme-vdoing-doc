...
module.exports = {
    ...
    themeConfig: {
        ...
        repo: 'meng1508754975', // 导航栏右侧生成Github链接
        ...
        indexImg: {
            ...
            desc: ["故事由我书写，旅程由你见证，传奇由她聆听", "这一生波澜壮阔或是不惊都没问题"],  // 多个描述，如果填写则覆盖 config.js 的 description，不填写默认读取 config.js 的 description，descFade 为 true 生效
            descFontSize: '1.3rem',   // desc 的字体大小，默认 1.4rem。提示：原主题是 1.1rem
            descFadeInTime: 300,  // 描述的淡入效果持续时间，descFade 为 true 生效，默认 200 毫秒
            descFadeOutTime: 200,  // 描述的淡出效果持续时间，descFade 为 true 生效，默认 100 毫秒
